...
class _MapPageState extends State<MapPage> {
  ...
  //  late double startLatitude = _startAddress as double ;
  // late double startLongitude = _startAddress as double ;
  // late double destinationLatitude = _destinationAddress as double;
  // late double destinationLongitude = _destinationAddress as double;
...
//   PolylineResult result = await polylinePoints.getRouteBetweenCoordinates(
//       googleAPIKey,
//       PointLatLng(startLatitude.toDouble(), startLongitude.toDouble()),
//       PointLatLng(destinationLatitude.toDouble(), destinationLongitude.toDouble()),
//       travelMode: TravelMode.driving,
//   );
//   // if (result.points.isNotEmpty) {
